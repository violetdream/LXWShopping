      ...
      <div class="dialog dialog-shadow" style="display: block; margin-top: -362px;">
        ...
        <div v-if="loginPage" class="content">
          <ul class="common-form">
            <li>
              <div class="input">
                <el-input class="form_input_style"  placeholder="请输入账号" v-model="ruleForm.userName" clearable></el-input>
<!--                <input type="text" v-model="ruleForm.userName" placeholder="账号">-->
              </div>
            </li>
            <li>
              <div class="input">
                <el-input class="form_input_style" placeholder="请输入密码" v-model="ruleForm.userPwd" @keyup.enter="login" show-password></el-input>
<!--                <input type="password" v-model="ruleForm.userPwd" @keyup.enter="login" placeholder="密码">-->
              </div>
            </li>
            <li>
              <div class="input">
                <el-input class="form_input_style" v-model="ruleForm.captcha" placeholder="验证码" clearable />
                <el-image id="imageCode" :src="imageCode" @click="init_geetest()"/>
...
<!--                <img id="imageCode" :src="imageCode" @click="init_geetest()"/>-->
            ...
            <li style="text-align: right">
              ...
              <a href="#" class="register" @click="toRegister">注册 商铺 账号</a>
          ...
          <div style="margin-top: 25px">
            <y-button :text="logintxt"
                      ...
                      @btnClick="login" style="marginTop: 10px;marginBottom: 15px;width: 100%;height: 48px;font-size: 18px;line-height: 48px"></y-button>
          </div>
          <!--返回-->
          <div>
...
<style lang="scss" rel="stylesheet/scss" scoped>
  * {
  ...
  .login {
    ...
    .form_input_style >>> .el-input__inner {
      height: 100%;
  ...
  .v2 .dialog {
    ...
    .title {
      ...
      position: relative;
      background-image: url(/static/images/logo_jumi.png);
