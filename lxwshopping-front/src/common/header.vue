        ...
        <div class="w-box">
          <div class="nav-logo">
            <h1 @click="changePage(-1)">
              <router-link to="/" title="商城"><i class="el-icon-present"></i>商城</router-link>
            </h1>
          </div>
          <div _ngcontent-c1="" class="container">
            <ul _ngcontent-c1="" class="nav-list"> <!---->
              <li _ngcontent-c1=""><a _ngcontent-c1="" class="active" title="在线商城" href="/" target="">在线商城 </a></li>
              <li _ngcontent-c1=""><a _ngcontent-c1="" title="聚米官网" href="http://zgjumi.cn/"target="_blank"> 聚米官网 </a></li>
<!--              <li _ngcontent-c1=""><a _ngcontent-c1="" title="坚果 R1"  href="//" target="_blank"></a></li>-->
            </ul>
          </div>
          <div class="right-box">
          ...
          <div class="nav-sub-wrapper" :class="{fixed:st}">
            <div class="w">
              <ul class="nav-list2">
                ...
                :key="i" v-if="item.panelId=='0'">
                <a @click="changGoods(i, item)" :class="{active:i===choosePage}">{{item.picUrl}}</a>
              </li>
              </ul>
              <div class="nav-search">
                <el-autocomplete placeholder="请输入商品信息" suffix-icon="el-icon-search" v-model="input"
                  :fetch-suggestions="querySearchAsync" @select="handleSelect" :on-icon-click="handleIconClick" @keydown.enter.native="handleIconClick">
                </el-autocomplete>
