  ...
  <footer>
    ...
    <div id="footer">
      <div class="footer-contert">
        <div class="footer-content-logo"><img src="static/images/logo_jumi.png" alt="底部LOGO"> <span>项目学习及开发用</span>
        </div>
        ...
        <div class="footer-content-service">
          <ul>
            <li>服务与支持</li>
            <li><a @click="open('联系方式','邮箱：liuxianweimarx@163.com QQ：854406842')">商务合作</a></li>
            <li><a @click="open1()">法律声明</a></li>
          </ul>
        </div>
        <div class="footer-content-img">
          <div class="footer-content-img-wx">
            <a @click="open5()">
            <span><i class="doc-icon-weixin elementdoc el-popover__reference"/></span>
              <span>微信</span>
            </a>
          </div>
          <div class="footer-content-img">
            <div class="footer-content-img-wx">
            <a href="//github.com/violetdream?tab=repositories" target="_blank">
              <span class="weibo"><i class="doc-icon-github elementdoc"/></span>
              <span>GitHub</span>
            </a>
            </div>
          </div>
  ...
  export default {
    ...
    methods: {
      ...
      open1 () {
        this.$notify.info({
          title: '法律声明',
          message: '此仅为个人练习开源项目，仅供学习参考，承担不起任何法律问题'
        })
      },
      open2 () {
        this.$notify.info({
