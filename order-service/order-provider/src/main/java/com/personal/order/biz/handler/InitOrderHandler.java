...
import com.personal.order.biz.callback.SendEmailCallback;
...
import com.personal.order.utils.GlobalIdGeneratorUtil;
import com.personal.tool.exception.ValidateException;
import com.personal.tool.utils.NumberUtils;
...
public class InitOrderHandler extends AbstractTransHandler {
    ...
    public boolean handle(TransHandlerContext context) {
        ...
        try {
            ...
            orderMapper.insertOrder(order); //保存订单
            ...
            log.error("订单重复提交："+e);
            throw new ValidateException(OrderRetCode.DB_SAVE_EXCEPTION.getCode(),OrderRetCode.DB_SAVE_EXCEPTION.getMessage());
        }catch (Exception e){
